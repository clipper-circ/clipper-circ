...
<style>
  *, *::before, *::after { box-sizing: border-box; }
  ...
  .header { background: #1a3a1a; padding: 10px 24px; display: flex; align-items: center; justify-content: center; position: relative; }
  .header h1 { color: white; margin: 0; font-size: 1.4em; letter-spacing: 1px; }
  .header-link { position: absolute; right: 24px; color: white; font-size: 0.9em; text-decoration: none; opacity: 0.9; }
...
<div class="header"><h1>Place an Obituary Notice</h1><a class="header-link" href="https://www.duxburyclipper.com/obituaries/" target="_blank">Current Obituaries</a></div>
<div class="wrap">
  <div class="steps">
